	...
	return props.float === "right" ? (
		<div className={`w-full font-fira text-white text-right float-right`}>
			...
			<a target="_blank" rel="noreferrer" href={props.link}>
				<ExternalLink className="mt-2.5 ml-4 float-right h-[22px] w-[22px] transition duration-500 ease-in-out fill-gray hover:fill-green" />
			</a>
			<a target="_blank" rel="noreferrer" href={props.github}>
				<Github className="mt-2.5 float-right h-[22px] w-[22px] transition duration-500 ease-in-out fill-gray hover:fill-green" />
			</a>
		</div>
	) : (
		<div className={`w-full font-fira text-white float-left text-left`}>
			...
			<p className="mt-3 text-sm">{props.languages}</p>
			<a target="_blank" rel="noreferrer" href={props.github}>
				<Github className="mt-2.5 mr-4 float-left h-[22px] w-[22px] transition duration-500 ease-in-out fill-gray hover:fill-green" />
			</a>
			<a target="_blank" rel="noreferrer" href={props.link}>
				<ExternalLink className="mt-2.5 float-left h-[22px] w-[22px] transition duration-500 ease-in-out fill-gray hover:fill-green" />
			</a>
		</div>
	);
}
